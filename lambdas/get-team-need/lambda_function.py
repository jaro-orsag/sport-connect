...
def lambda_handler(event, _): 
    try:
        ...
        logger.info("getting team-need", extra={
            'uuid': uuid, 
            'need_type': "team_need", 
            'operation': 'get', 
            'stage': 'started'
        ...
        with conn.cursor() as cursor:
            ...
            if result is None:
                logger.info("team-need not found", extra={
                    'uuid': uuid, 
                    'need_type': "team_need", 
                    'operation': 'get', 
                    'stage': 'not_found'
            ...
            response = {
                ...
                'phone': result['phone'],
                'about': result['about'],
                'isMarketingConsentGranted': int_to_bool(result['isMarketingConsentGranted']),
