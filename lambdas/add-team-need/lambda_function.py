...
def lambda_handler(event, _): 
    ...
    try:
        ...
        with conn.cursor() as cursor:
            sql = "INSERT INTO TeamNeed (uuid, isActive, districtCode, address, time, playerName, email, phone, about, dateAdded) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
            user_data = (body_dict['uuid'], body_dict['isActive'], body_dict['districtCode'], body_dict['address'], body_dict['time'], body_dict['playerName'], body_dict['email'], body_dict['phone'], body_dict['about'], utc_now)
